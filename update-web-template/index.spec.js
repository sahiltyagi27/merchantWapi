...
describe('Update Web Templates', () => {
    ...
    it('should update schedules doc when all validation pass', async () => {
        ...
        const result = await request.patch(`${helpers.API_URL}/api/v1/web-templates/${sampleWebTemplates._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            },
        ...
        expect(result.description).to.be.equal('Successfully update the specified web-template');
    ...
    it('should not delete schedules when db don\'t have schedules with this id.', async () => {
        ...
        try {
            await request.patch(`${helpers.API_URL}/api/v1/web-templates/${uuid.v4()}`, {
                json: true,
                headers: {
                    'Authorization': authToken
                },
    ...
    it('should return error when id is not in uuid format', async () => {
        ...
        try {
            await request.patch(`${helpers.API_URL}/api/v1/web-templates/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                },
