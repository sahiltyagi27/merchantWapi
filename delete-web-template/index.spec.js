...
describe('Delete Web Templates', () => {
    ...
    it('should delete doc when all validation pass', async () => {
        ...
        const result = await request.delete(`${helpers.API_URL}/api/v1/web-templates/${sampleWebTemplates._id}`, {
            json: true,
            headers: {
                'Authorization': authToken
            }
        ...
        expect(result.description).to.be.equal('Successfully deleted the specified web-template');
    });
    ...
    it('should return error when id is not in uuid format', async () => {
        ...
        try {
            await request.delete(`${helpers.API_URL}/api/v1/web-templates/123`, {
                json: true,
                headers: {
                    'Authorization': authToken
                }
